...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="fixed left-[-240px]">
      <div
        className={
          isOpen
            ? "fixed  top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform translate-x-full"
            : "fixed  top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform"
        }
      >
        <Link
          to="/"
        ...
        <ul className="mt-4">
          ...
          <li className="mb-1 group">
            ...
            <ul className="pl-7 mt-2 hidden group-[.selected]:block">
              <li className="mb-4">
                <a
                  href=""
                  className="text-gray-900 text-lg flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3"
                >
                  All
                </a>
              </li>
          ...
          <li className="mb-1 group">
            <a
              ...
              className="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100"
            >
              <i className="fa-solid fa-box mr-[13px]"></i>
