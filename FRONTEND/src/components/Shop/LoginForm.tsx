        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          >
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-[#F9F1E7] px-3 py-1.5 text-sm font-semibold leading-6 text-black shadow-sm hover:bg-[#B88E2F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Sign in
              </button>
            </div>
