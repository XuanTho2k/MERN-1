             ...
             title-font text-gray-500 tracking-widest"
              ...
              <div className="mx-auto max-w-[1440px] mt-[80px] flex flex-col justify-center">
                ...
                <div className="ml-[220px] mt-[40px] text-[#9f9f9f] w-[1026px] leading-[24px] ">
                  ...
                  ‘n’ roll, the Kilburn portable active
                  stereo speaker takes the unmistakable look
                  and sound of Marshall, unplugs the chords,
                  and takes the show on the road.
                  <br />
                  <br />
                  Weighing in under 7 pounds, the Kilburn is
                  a lightweight piece of vintage styled
                  ...
                  that is both articulate and pronounced.
                  The analogue knobs allow you to fine tune
